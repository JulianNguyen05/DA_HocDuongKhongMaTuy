    ...
    <>
     ...
     {/* =========================================
        ...
        {currentPlatforms.map((plat, index) => (
          <div
            key={index}
            className="absolute bg-red-500/40 border-2 border-red-600 flex items-center justify-center text-white text-xs font-bold pointer-events-none z-10"
            style={{
              left: `${plat.left}%`,
              bottom: `${plat.bottom}%`, 
              width: `${plat.width}%`,
      ...
      */}
      ...
      {/* GAMEPAD CHO MOBILE */}
      <div className="absolute bottom-6 left-0 right-0 px-8 flex justify-between items-end z-[60] pointer-events-none lg:hidden">
